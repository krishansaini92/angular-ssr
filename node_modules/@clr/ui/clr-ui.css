...
.btn-group.btn-primary .dropdown-toggle cds-icon, .btn-group.btn-success .dropdown-toggle cds-icon, .btn-group.btn-warning .dropdown-toggle cds-icon, .btn-group.btn-danger .dropdown-toggle cds-icon {
  /* clr-btn-primary-color */
  color: white;
  color: var(--clr-btn-primary-color, white);
}
...
.close:focus cds-icon, .close:hover cds-icon, .close:active cds-icon {
  /* clr-close-color--hover */
  fill: black;
